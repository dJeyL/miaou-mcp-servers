    ...
    def __init__(self) -> None:
        ...
        async def brave_search(
            ...
            try:
                ...
                if e.code == 429:
                    return "Erreur 429 : quota Brave Search dépassé."
                return f"Erreur HTTP {e.code} ({e.reason}) — Brave Search"
            except urllib.error.URLError as e:
                return f"Erreur réseau ({e.reason}) — Brave Search"
            except TimeoutError:
                return "Timeout (10 s) — Brave Search"
            except Exception as e:
                return f"Erreur inattendue ({type(e).__name__}: {e}) — Brave Search"
